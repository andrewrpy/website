...
The code here below is a **grid search** in order to make all the possible permutations of both K and columns, using K from 1 to 15 and we have 10 columns. There are 7665 permetations of these values.
