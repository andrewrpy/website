...
The results above show the Confusion Matrix and the relative Accuracy (94%).
Based on a very simple Decision Trees Model we can identify email with a 94% of Accuracy. We are also able thanks to the graph above to see which predictors had an important role to identify if the email was spam or not.
