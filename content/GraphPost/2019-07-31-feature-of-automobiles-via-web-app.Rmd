...
It is an interactive approach to telling data story. Here below, an example using feaure of cars from the [**Mtcars**](https://stat.ethz.ch/R-manual/R-devel/library/datasets/html/mtcars.html) dataset.
